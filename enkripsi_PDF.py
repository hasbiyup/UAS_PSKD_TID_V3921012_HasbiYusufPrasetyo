...
# buka file pdf asli 
file = PdfFileReader("C:/Users/hasbi/OneDrive/Documents/phyton/pdf/file_pdf.pdf")
...
with open("C:/Users/hasbi/OneDrive/Documents/phyton/pdf/enkripPDFUAS.pdf", "wb") as f:
