...
file = PdfFileReader("C:/Users/hasbi/OneDrive/Documents/phyton/pdf/enkripPDFUAS.pdf")
...
if file.isEncrypted:
    ...
    with open("C:/Users/hasbi/OneDrive/Documents/phyton/pdf/deskripsiPDFUAS.pdf", "wb") as f:
